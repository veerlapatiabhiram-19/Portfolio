  ...
  return (
    <section id="home" style={{
      ...
      <div style={{ flex: 1, minWidth: '280px', maxWidth: '600px' }}>
        <p style={{ color: 'var(--accent)', fontSize: '1.1rem', fontWeight: 500, marginBottom: '0.5rem' }}>
          Hello, I'm
        </p>
        <h1 style={{ fontSize: 'clamp(2.8rem, 7vw, 5rem)', fontWeight: 900, lineHeight: 1.1, color: 'var(--accent)', marginBottom: '1.2rem', textShadow: '0 0 40px rgba(0,212,255,0.3)' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '2.5rem' }}>
          ...
          <a href="#contact" style={{ padding: '0.8rem 2rem', background: 'rgba(255,255,255,0.07)', color: 'var(--text)', border: '1px solid rgba(255,255,255,0.15)', borderRadius: '8px', fontWeight: 600, fontSize: '1rem', transition: 'background 0.2s, transform 0.2s' }}
      ...
      <style>{`
        @media (max-width: 768px) {
          section#home { flex-direction: column !important; align-items: center !important; padding: 5rem 1.5rem 2rem !important; text-align: center; }
        }
      `}</style>
    </section>
  )
