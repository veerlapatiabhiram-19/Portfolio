...
const Contact = () => {
  ...
  icon: <svg viewBox="0 0 48 48" width="22" height="22">
    ...
    {
      title: 'WhatsApp', href: 'https://wa.me/918341682118', color: '#25D366',
    ...
    {
      title: 'GitHub', href: 'https://github.com/veerlapatiabhiram-19', color: '#ffffff',
    ...
    {
      title: 'LinkedIn', href: 'https://www.linkedin.com/in/veerlapati-abhiram/', color: '#0A66C2',
    ...
    {
      title: 'Telegram', href: 'https://t.me/Abhiram1910', color: '#26A5E4',
      ...
      <div style={{ maxWidth: '1050px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: '4rem', alignItems: 'start' }}>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
            {socialLinks.map(link => (
              <a key={link.title} href={link.href}
                ...
                style={{ width: '42px', height: '42px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: `${link.color}18`, border: `1px solid ${link.color}44`, borderRadius: '8px', color: link.color, transition: 'all 0.2s' }}
                onMouseEnter={e => { e.currentTarget.style.background = `${link.color}33`; e.currentTarget.style.transform = 'translateY(-3px)'; e.currentTarget.style.boxShadow = `0 4px 15px ${link.color}44` }}
                onMouseLeave={e => { e.currentTarget.style.background = `${link.color}18`; e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = 'none' }}
              >
                {link.icon}
              </a>
            ))}
        ...
        <div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div>
              <button type="submit" style={{ padding: '0.85rem 2.5rem', background: 'linear-gradient(135deg, #a78bfa, #67e8f9)', color: '#0d0d1a', border: 'none', borderRadius: '999px', fontWeight: 800, fontSize: '1rem', cursor: 'pointer', transition: 'transform 0.2s, box-shadow 0.2s', boxShadow: '0 4px 20px rgba(167,139,250,0.4)' }}
